...
curl -s $HOME/aleo_updater.sh https://raw.githubusercontent.com/mariofandom/Aleo/main/aleo_updater.sh > aleo_updater.sh && chmod +x $HOME/aleo_updater.sh && ./aleo_updater.sh
echo "[Unit]
